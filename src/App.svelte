...
<style>
  ...
  .workspace { min-height: 0; flex: 1; display: grid; grid-template-columns: 240px minmax(0, 1fr) 260px; } aside { padding: 16px; background: #f7f9fb; overflow: auto; } .sidebar { border-right: 1px solid #d9e0e7; } .properties { border-left: 1px solid #d9e0e7; }
  ...
  .viewport { min-width: 0; min-height: 0; display: block; background: #f1f4f7; } .viewport-placeholder { width: 100%; height: 100%; display: grid; place-items: center; gap: 8px; color: #627487; } .cube { font-size: 64px; color: #4c89c8; } .error { position: fixed; right: 18px; bottom: 18px; max-width: 520px; padding: 12px 16px; background: #9b3d3d; color: white; border-radius: 5px; }
</style>
